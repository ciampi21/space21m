-- Atualizar função calculate_referral_tier com nova estrutura de 6 tiers
-- Tier 1 (Iron) = usuário free | Tier 2 (Copper) = usuário pago
...
BEGIN
  ...
  -- Tier 5 - Gold: 10+ indicações pagas → +10% armazenamento
  ...
  -- Tier 4 - Silver: 5+ indicações pagas
